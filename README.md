...
| 12 | 运行时与性能 | LLM 流式响应与异步任务架构 | [阅读](docs/面试/运行时/llm-streaming-and-async-architecture.md) |
| 13 | Agent 与编排 | LLM 工作流编排与 Human-in-the-loop | [阅读](docs/面试/工作流/llm-workflow-orchestration-and-human-in-the-loop.md) |
| 14 | 生产化与 LLMOps | 模型网关与多模型路由 | [阅读](docs/面试/生产化/llm-model-gateway-and-routing.md) |
| 15 | 数据与查询 | Text-to-SQL / NL2SQL 应用开发 | [阅读](docs/面试/数据查询/text-to-sql-nl2sql-application-development.md) |
| 16 | Agent 与编排 | MCP 服务端与客户端集成 | [阅读](docs/面试/模型上下文协议/model-context-protocol-server-and-client-integration.md) |
| 17 | 生产化与 LLMOps | LLM 应用测试与 Mock 策略 | [阅读](docs/面试/测试/llm-application-testing-and-mocking.md) |
...
| 26 | 专项进阶 | 实时语音 Agent 架构设计 | [阅读](docs/面试/语音代理/realtime-voice-agent-architecture.md) |
| 27 | 生产化与 LLMOps | 开源大模型私有化部署与推理服务 | [阅读](docs/面试/部署/open-source-llm-private-deployment-and-inference-serving.md) |
